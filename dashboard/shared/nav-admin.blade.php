        ...
        <ul class="c-nav">
          ...
          <li class="c-nav-item c-nav-dropdown"><a class="c-nav-link c-nav-dropdown-toggle" href="#">
            ...
            <ul class="c-nav-dropdown-items">
              <li class="c-nav-item"><a class="c-nav-link" href="/base/breadcrumb"><span class="c-nav-icon"></span>hardware</a></li>
              <li class="c-nav-item"><a class="c-nav-link" href="/base/cards"><span class="c-nav-icon"></span> software</a></li>
              <li class="c-nav-item"><a class="c-nav-link" href="/base/carousel"><span class="c-nav-icon"></span> vehicle</a></li>
              <li class="c-nav-item"><a class="c-nav-link" href="/base/collapse"><span class="c-nav-icon"></span> stationary</a></li>
              <li class="c-nav-item"><a class="c-nav-link" href="/base/forms"><span class="c-nav-icon"></span> furniture</a></li>
          ...
          <li class="c-nav-item c-nav-dropdown"><a class="c-nav-link c-nav-dropdown-toggle" href="#">
            ...
            <ul class="c-nav-dropdown-items">
              <li class="c-nav-item"><a class="c-nav-link" href="/buttons/buttons"><span class="c-nav-icon"></span> Fuel </a></li>
              <li class="c-nav-item"><a class="c-nav-link" href="/buttons/button-group"><span class="c-nav-icon"></span> Payments</a></li>
              <li class="c-nav-item"><a class="c-nav-link" href="/buttons/dropdowns"><span class="c-nav-icon"></span> stores </a></li>
