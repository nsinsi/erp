...
<head>
  ...
  @include('requisitions.storesModal')
  @include('requisitions.travelModal')

  @include('liquidations.cashModal')
  @include('liquidations.fuelliModal')
  @include('leave.applicationModal')
  @include('item.reportModal')
  @include('item.bookModal')
  <base href="./">
  <meta charset="utf-8">
