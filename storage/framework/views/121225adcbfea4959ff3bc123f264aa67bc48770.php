  ...
  <div class="fade-in">
    <div class="row">
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="card text-white home-card">
          <div class="card-body card-body pb-0 d-flex justify-content-between align-items-start">
            ...
            <?php endif; ?>
            <?php if(auth()->check() && auth()->user()->hasRole('sm')): ?>
            <div>
      ...
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table class="table table-responsive-sm table-bordered">
                ...
                <tbody>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $requisitions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td>{ ++ }</td>
                    <td><a  href=""><?php echo e($requisitions->user->first_name); ?></a></td>
                    <td ><?php echo e($requisitions->amount); ?></td>
                    <td><?php echo e($requisitions->payableto->full_name); ?></td>
                    <td ><?php echo e($requisitions->status->name); ?></td>
                    <td>
                      <div class="dropdown">
        ...
        <?php endif; ?>
      <?php if(auth()->check() && auth()->user()->hasRole('Project Officer')): ?>
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-12">
          ...
          <?php endif; ?>
        <?php if(auth()->check() && auth()->user()->hasRole('Program Support Manager')): ?>
      <div class="col-md-12">
        <div class="card">
          <div class="card-header" >Requistions</div>
          <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views/layouts/home.blade.php ENDPATH**/ ?>